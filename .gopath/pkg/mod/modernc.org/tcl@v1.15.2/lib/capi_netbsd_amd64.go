// Code generated by 'ccgo -D__printf__=printf -export-defines  -export-enums  -export-externs X -export-fields F -export-structs  -export-typedefs  -hide TclpCreateProcess -lmodernc.org/z/lib -o lib/tcl_netbsd_amd64.go -pkgname tcl -replace-fd-zero __ccgo_fd_zero -replace-tcl-default-double-rounding __ccgo_tcl_default_double_rounding -replace-tcl-ieee-double-rounding __ccgo_tcl_ieee_double_rounding -trace-translation-units --load-config  -save-config  /tmp/go-generate-26389458/cdb.json libtcl8.6.a libtclstub8.6.a', DO NOT EDIT.
