// Code generated by 'ccgo -D__printf__=printf -export-defines  -export-enums  -export-externs X -export-fields F -export-structs  -export-typedefs  -hide TclWinCPUID -lmodernc.org/z/lib -o lib/tcl_windows_amd64.go -pkgname tcl -replace-fd-zero __ccgo_fd_zero -replace-tcl-default-double-rounding __ccgo_tcl_default_double_rounding -replace-tcl-ieee-double-rounding __ccgo_tcl_ieee_double_rounding -trace-translation-units --load-config  -save-config  /tmp/go-generate-271272855/cdb.json libtcl86.a libtclstub86.a', DO NOT EDIT.
