// Code generated by 'ccgo -lmodernc.org/z/lib -o internal/minigzip_linux_arm.go -trace-translation-units /tmp/go-generate-1705985058/cdb.json minigzip64', DO NOT EDIT.
...
func gz_compress(tls *libc.TLS, in uintptr, out gzFile) { /* minigzip.c:362:6: */
	...
	for {
		len = int32(libc.Xfread(tls, bp /* &buf[0] */, uint32(1), uint32(unsafe.Sizeof([16384]uint8{})), in))
...
func file_compress(tls *libc.TLS, file uintptr, mode uintptr) { /* minigzip.c:457:6: */
	...
	libc.Xsnprintf(tls, bp+40 /* &outfile[0] */, uint32(unsafe.Sizeof([1024]uint8{})), ts+84 /* "%s%s" */, libc.VaList(bp+8, file, ts+57 /* ".gz" */))
...
func file_uncompress(tls *libc.TLS, file uintptr) { /* minigzip.c:496:6: */
	...
	if (len + libc.Xstrlen(tls, ts+57 /* ".gz" */)) >= uint32(unsafe.Sizeof([1024]uint8{})) {
		libc.Xfprintf(tls, libc.Xstderr, ts+61 /* "%s: filename too..." */, libc.VaList(bp, prog))
		libc.Xexit(tls, 1)
	}

	libc.Xsnprintf(tls, bp+40 /* &buf[0] */, uint32(unsafe.Sizeof([1024]uint8{})), ts+113 /* "%s" */, libc.VaList(bp+8, file))

	if (len > (uint32(unsafe.Sizeof([4]uint8{})) - uint32(1))) && (libc.Xstrcmp(tls, ((file+uintptr(len))-uintptr((uint32(unsafe.Sizeof([4]uint8{}))-uint32(1)))), ts+57 /* ".gz" */) == 0) {
		infile = file
		outfile = bp + 40 /* &buf[0] */
		*(*uint8)(unsafe.Pointer(outfile + uintptr((len - uint32(3))))) = uint8(0)
		...
		outfile = file
		infile = bp + 40 /* &buf[0] */
		libc.Xsnprintf(tls, (bp + 40 /* &buf[0] */ + uintptr(len)), (uint32(unsafe.Sizeof([1024]uint8{})) - len), ts+113 /* "%s" */, libc.VaList(bp+16, ts+57 /* ".gz" */))
	}
...
func main1(tls *libc.TLS, argc int32, argv uintptr) int32 { /* minigzip.c:556:5: */
	...
	libc.Xsnprintf(tls, bp+24 /* &outmode[0] */, uint32(unsafe.Sizeof([20]uint8{})), ts+113 /* "%s" */, libc.VaList(bp, ts+119 /* "wb6 " */))
