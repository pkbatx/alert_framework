// Code generated by 'ccgo -lmodernc.org/z/lib -o internal/example_linux_s390x.go -trace-translation-units /tmp/go-generate-1577412705/cdb.json example64', DO NOT EDIT.
...
var hello = *(*[14]uint8)(unsafe.Pointer(ts /* "hello, hello!" */)) /* example.c:29:21 */
// "hello world" would be more standard, but the repeated "hello"
// stresses the compression code better, sorry...

var dictionary = *(*[6]uint8)(unsafe.Pointer(ts + 14 /* "hello" */)) /* example.c:34:19 */
